...
import { workerSignIn } from "../actions";
...
export default function WorkerLogin() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const result = await workerSignIn(new FormData(e.currentTarget));
    ...
    <div style={{ minHeight: "100vh", background: "#f9fafb", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <div style={{ width: "100%", maxWidth: 420 }}>
        ...
        <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 20, padding: "40px 36px", boxShadow: "0 4px 24px rgba(0,0,0,0.06)" }}>
          <h1 style={{ fontSize: 24, fontWeight: 800, color: "#111827", marginBottom: 6 }}>Worker Sign In</h1>
          <p style={{ fontSize: 14, color: "#6b7280", marginBottom: 28 }}>Welcome back — find your next shift</p>
          ...
          <p style={{ textAlign: "center", fontSize: 13, color: "#6b7280", marginTop: 24 }}>
            ...
            <a href="/worker/signup" style={{ color: "#7c3aed", fontWeight: 600, textDecoration: "none" }}>Sign up</a>
          </p>
        </div>
      </div>
    </div>
