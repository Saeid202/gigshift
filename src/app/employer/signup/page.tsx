    ...
    <div style={{ minHeight: "100vh", background: "#f9fafb", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <div style={{ width: "100%", maxWidth: 440 }}>
        ...
        <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 20, padding: "40px 36px", boxShadow: "0 4px 24px rgba(0,0,0,0.06)" }}>
          <h1 style={{ fontSize: 24, fontWeight: 800, color: "#111827", marginBottom: 6 }}>Create Employer Account</h1>
          <p style={{ fontSize: 14, color: "#6b7280", marginBottom: 28 }}>Start posting shifts and finding workers today</p>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div>
              ...
              <input name="company_name" type="text" required placeholder="Acme Logistics"
                style={{ width: "100%", padding: "11px 14px", borderRadius: 10, border: "1px solid #d1d5db", fontSize: 14, color: "#111827", outline: "none", boxSizing: "border-box" }} />
            </div>
            <div>
          ...
          <p style={{ textAlign: "center", fontSize: 13, color: "#6b7280", marginTop: 24 }}>
            ...
            <a href="/employer/login" style={{ color: "#7c3aed", fontWeight: 600, textDecoration: "none" }}>Sign in</a>
          </p>
        </div>
      </div>
    </div>
